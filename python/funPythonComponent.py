...
# AUTO-GENERATED
#
# Source: funPythonComponent.spd.xml
from ossie.resource import start_component
import logging

from funPythonComponent_base import *

class funPythonComponent_i(funPythonComponent_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", funPythonComponent_i.MyMsg, self.msg_callback)
            ...
            msg_out = funPythonComponent_i.MyMsg()
...
if __name__ == '__main__':
    ...
    start_component(funPythonComponent_i)
